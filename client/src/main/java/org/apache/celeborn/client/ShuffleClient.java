    ...
    if (null == _instance || !initialized) {
      synchronized (ShuffleClient.class) {
        if (null == _instance) {
          ...
          // ShuffleClient is building a singleton, it may cause the LifecycleManagerEndpoint to not be assigned.
          // An Executor will only construct a ShuffleClient singleton once. At this time,
